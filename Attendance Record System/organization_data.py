...
class Organization:
    ...
    #
    # def show_annual_attendance(self, employeeID):
    #     """Function will return the annual attendance data"""
    #     employee = self.get_employee(employeeID)
    #     print(employee["months"])
    #
    # def show_monthly_attendance(self, employeeID, attendance_month):
    #     """Function will return the attendance data of a specified month"""
    #     employee = self.get_employee(employeeID)
    #     print(employee["months"][attendance_month])
    #
    # def mark_attendance(self, employeeID, employee_month, employee_date):
    #     """Function will mark the attendance of the employee"""
    #     for month, value in self.get_employee(employeeID)["months"].items():
    #         if month == employee_month:
    #             value.append(employee_date)
    #
    ...
    #
    # def return_working_days(self, employeeID, attendance_month):
    #     """Function will return total working days of a specific month of a sepcific employee"""
    #     employee = self.get_employee(employeeID)
    #     working_days = employee["months"][attendance_month]
    #     return working_days
    #
