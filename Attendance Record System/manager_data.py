...
class Manager:
    def __init__(self):
        self.__manager_options = f"""Below are the options you have access to:
1. Show all employees of the department.
...
3. Show attendance"""
    ...
    def set_my_details(self, owner_details):
        """function will save the details"""
        self.__details = owner_details

    def self_attendance(self):
        """function will display the attendance of the manager itself."""
    ...
    def department_attendance(self):
        """function will display the attendance of the entire department, manager belongs to."""
    ...
    def checking_department_defaulters(self):
        """function will display the defaulters if any """
    ...
    def manager_options(self, choice):
        """function will operate based on manager's task choice"""
        if choice == 1:
